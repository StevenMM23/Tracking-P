...
namespace DAL
{
    ...
    partial void InsertDEPARMENT(DEPARMENT instance);
    partial void UpdateDEPARMENT(DEPARMENT instance);
    partial void DeleteDEPARMENT(DEPARMENT instance);
    ...
    partial void DeleteTaskState(TaskState instance);
		...
		public System.Data.Linq.Table<DEPARMENT> DEPARMENTs
		{
			get
			{
				return this.GetTable<DEPARMENT>();
			}
		}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.DEPARMENT")]
	public partial class DEPARMENT : INotifyPropertyChanging, INotifyPropertyChanged
	{
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.PermissionStates")]
    ...
    partial void OnMothIDChanging(int value);
    partial void OnMothIDChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_MothID", DbType="Int NOT NULL")]
		public int MothID
		{
			get
			{
			...
			set
			{
				if ((this._MothID != value))
				{
					this.OnMothIDChanging(value);
					this.SendPropertyChanging();
					this._MothID = value;
					this.SendPropertyChanged("MothID");
					this.OnMothIDChanged();
				}
			}
		}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.TaskStates")]
